...
const clearDnsCache = () => {
  chrome.tabs.create(
    { url: 'chrome://net-internals', active: false },
    (tab) => {
  ...
  return (
    <>
      ...
      <div className="qrtext">
        {showOptions ? HSHEN_CONF.optionsText : HSHEN_CONF.qrText}
      </div>
      ...
      <div className="author">
        <a href="http://hackshen.com" target="_blank" rel="noreferrer">
          {HSHEN_CONF.author}
        </a>
      </div>
    </>
