...
checkBrowsers(paths.appPath, isInteractive)
  ...
  .then(port => {
    ...
    process.env.REACT_APP__HOST = 'localhost';
    ...
    const serverConfig = {
      ...
      setupMiddlewares: (middlewares, _devServer) => {
        ...
        const watchRunDir = ['content', 'background'];
        if (!_devServer) {
        ...
        _devServer.compiler.hooks.watchRun.tap('WatchRun', (comp) => {
          if (comp.modifiedFiles) {
            const changedFiles = Array.from(comp.modifiedFiles, (file) => `${file}`).join('');
        ...
        _devServer.compiler.hooks.done.tap('contentOrBackgroundChangedDone', () => {
        ...
        _devServer.compiler.hooks.failed.tap('contentOrBackgroundChangeError', () => {
          contentOrBackgroundIsChange = false;
        })
        return middlewares;
      }
